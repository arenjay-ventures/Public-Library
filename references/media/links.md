...
- [GPT-3: Language Models are Few-Shot Learners](https://arxiv.org/abs/2005.14165) - Large Language Models
- [Vision Transformer (ViT)](https://arxiv.org/abs/2010.11929) - Image Classification with Transformers
- [Generative Adversarial Networks](https://arxiv.org/abs/1406.2661) - GANs Original Paper
- [Deep Residual Learning for Image Recognition](https://arxiv.org/abs/1512.03385) - ResNet Architecture
- [Long Short-Term Memory](https://www.bioinf.jku.at/publications/older/2604.pdf) - LSTM Networks
- [Convolutional Neural Networks for Visual Recognition](https://cs231n.stanford.edu/) - CNN Fundamentals
- [Reinforcement Learning: An Introduction](https://web.stanford.edu/class/psych209/Readings/SuttonBartoIPRLBook2ndEd.pdf) - RL Textbook
...
- [Applied Cryptography](https://www.schneier.com/books/applied-cryptography/) - Cryptography Fundamentals
...
- [SANS Top 25](https://cwe.mitre.org/top25/) - Most Dangerous Software Errors
- [Zero Trust Architecture](https://www.nist.gov/publications/zero-trust-architecture) - NIST Special Publication

### Blockchain & Cryptocurrency
- [Bitcoin: A Peer-to-Peer Electronic Cash System](https://bitcoin.org/bitcoin.pdf) - Satoshi Nakamoto's Original Paper
- [Ethereum: A Next-Generation Smart Contract Platform](https://ethereum.org/en/whitepaper/) - Ethereum Whitepaper
- [Solana: A New Architecture for a High Performance Blockchain](https://solana.com/solana-whitepaper.pdf) - Solana Whitepaper
- [The Lightning Network](https://lightning.network/lightning-network-paper.pdf) - Bitcoin Scaling Solution
- [Consensus in the Age of Blockchains](https://arxiv.org/abs/1711.03936) - Blockchain Consensus Mechanisms
- [Smart Contracts: Building Blocks for Digital Markets](https://www.fon.hum.uva.nl/rob/Courses/InformationInSpeech/CDROM/Literature/LOTwinterschool2006/szabo.best.vwh.net/smart.contracts.html) - Smart Contract Theory
...
- [Coursera (Free)](https://www.coursera.org/) - Free courses from top universities
- [edX](https://www.edx.org/) - Free online courses from MIT, Harvard, etc.
...
- [Harvard Online Learning](https://online-learning.harvard.edu/) - Free Harvard courses
...
- [Codecademy (Free)](https://www.codecademy.com/) - Free coding lessons
- [W3Schools](https://www.w3schools.com/) - Free web development tutorials
- [Mozilla Developer Network](https://developer.mozilla.org/) - Free web docs
- [Google Developers](https://developers.google.com/) - Free Google resources
...
- [Vue.js Documentation](https://vuejs.org/guide/) - Vue.js framework docs
...
- [Apache Documentation](https://httpd.apache.org/docs/) - Apache web server
- [Linux Documentation](https://www.kernel.org/doc/) - Linux kernel docs
- [Ubuntu Documentation](https://help.ubuntu.com/) - Ubuntu Linux docs
- [Arch Linux Wiki](https://wiki.archlinux.org/) - Arch Linux documentation
...
- [CWE Database](https://cwe.mitre.org/) - Common Weakness Enumeration
- [SANS Top 25](https://cwe.mitre.org/top25/) - Most Dangerous Software Errors
- [NIST Special Publications](https://csrc.nist.gov/publications/sp) - Security guidelines
...
- [SOC 2](https://www.aicpa.org/interestareas/frc/assuranceadvisoryservices/aicpasoc2report) - Service Organization Control 2
- [Zero Trust Architecture](https://www.nist.gov/publications/zero-trust-architecture) - NIST Zero Trust
...
- [MIT OpenCourseWare](https://www.youtube.com/c/mitocw) - MIT course lectures
- [Stanford](https://www.youtube.com/c/stanford) - Stanford university content
- [Harvard](https://www.youtube.com/c/harvard) - Harvard university content
- [Berkeley](https://www.youtube.com/c/UCBerkeley) - UC Berkeley lectures
...
- [Derek Banas](https://www.youtube.com/c/derekbanas) - Programming tutorials
- [Programming with Mosh](https://www.youtube.com/c/programmingwithmosh) - Programming tutorials
- [Coding Tech](https://www.youtube.com/c/CodingTech) - Technology conferences
- [Fireship](https://www.youtube.com/c/Fireship) - Quick tech explanations
- [Web Dev Simplified](https://www.youtube.com/c/WebDevSimplified) - Web development
- [Code with Harry](https://www.youtube.com/c/CodeWithHarry) - Programming tutorials
...
- [Professor Messer](https://www.youtube.com/c/ProfessorMesser) - IT certification training
- [Hak5](https://www.youtube.com/c/Hak5) - Security tools and techniques
- [Black Hat](https://www.youtube.com/c/BlackHatOfficialYT) - Security conference talks
- [DEF CON](https://www.youtube.com/c/DEFCONConference) - Hacker conference talks
- [SANS Digital Forensics](https://www.youtube.com/c/SANSDigitalForensics) - Digital forensics
- [Cybrary](https://www.youtube.com/c/Cybrary) - Cybersecurity training
...
- [Ethereum Foundation](https://www.youtube.com/c/EthereumFoundation) - Ethereum development
- [Solana](https://www.youtube.com/c/SolanaLabs) - Solana blockchain
- [Chainlink](https://www.youtube.com/c/ChainlinkOfficial) - Oracle networks

## Full Course Links

### Programming & Development (Free)
- [CS50: Introduction to Computer Science (Python Focus)](https://www.youtube.com/playlist?list=PLhQjrBD2T382_R182iC2gNZI9HzWFMC_8) - Harvard University (YouTube)
- [CS50 Python](https://www.youtube.com/playlist?list=PLhQjrBD2T383f9scHRNYJkior2VvYjpSL) - Harvard CS50 Python (YouTube)
- [Python for Everybody](https://www.coursera.org/specializations/python) - University of Michigan (Free)
- [The Odin Project](https://www.theodinproject.com/) - Full-stack web development (Free)
...
### Cybersecurity (Free)
- [Cybersecurity Specialization](https://www.coursera.org/specializations/cyber-security) - University of Maryland (Free)
- [Cybrary](https://www.cybrary.it/) - Free cybersecurity courses
- [SANS Free Resources](https://www.sans.org/free/) - Free SANS materials
- [TryHackMe](https://tryhackme.com/) - Free hands-on cybersecurity training
- [HackTheBox](https://www.hackthebox.com/) - Free penetration testing labs
- [OverTheWire](https://overthewire.org/) - Free wargames
- [PicoCTF](https://picoctf.org/) - Free capture the flag competition
- [Cybrary Free Courses](https://www.cybrary.it/catalog/) - Free cybersecurity training

### Cloud & DevOps (Free)
- [AWS Free Training](https://aws.amazon.com/training/) - Amazon Web Services (Free)
- [Google Cloud Free Training](https://cloud.google.com/training) - Google Cloud (Free)
- [Microsoft Learn](https://docs.microsoft.com/en-us/learn/) - Microsoft Azure (Free)
- [Docker Official Tutorials](https://docs.docker.com/get-started/) - Docker (Free)
- [Kubernetes Official Tutorials](https://kubernetes.io/docs/tutorials/) - Kubernetes (Free)
- [Terraform Learn](https://learn.hashicorp.com/terraform) - HashiCorp (Free)
- [Ansible Documentation](https://docs.ansible.com/) - Ansible (Free)
- [Jenkins Tutorials](https://www.jenkins.io/doc/tutorials/) - Jenkins (Free)

### Blockchain & Cryptocurrency (Free)
- [Ethereum Developer Resources](https://ethereum.org/en/developers/) - Ethereum Foundation (Free)
- [Solana Developer Resources](https://docs.solana.com/) - Solana Labs (Free)
- [Bitcoin Developer Guide](https://bitcoin.org/en/developer-guide) - Bitcoin.org (Free)
- [Web3 University](https://www.web3.university/) - Web3 development (Free)
...
- [PentesterLab](https://pentesterlab.com/) - Web application security labs
- [Cybrary Labs](https://www.cybrary.it/catalog/) - Free cybersecurity labs
- [SANS Cyber Ranges](https://www.sans.org/cyber-ranges/) - SANS training environments
...
- [MySQL Workbench](https://www.mysql.com/products/workbench/) - MySQL database tool
- [pgAdmin](https://www.pgadmin.org/) - PostgreSQL administration tool
- [MongoDB Compass](https://www.mongodb.com/products/compass) - MongoDB GUI

### Security Tools
- [Burp Suite Community](https://portswigger.net/burp/communitydownload) - Web application security testing (Free)
- [OWASP ZAP](https://www.zaproxy.org/) - Web application security scanner (Free)
- [Nmap](https://nmap.org/) - Network discovery and security auditing (Free)
- [Wireshark](https://www.wireshark.org/) - Network protocol analyzer (Free)
- [Metasploit Community](https://www.metasploit.com/) - Penetration testing framework (Free)
- [John the Ripper](https://www.openwall.com/john/) - Password cracking tool (Free)
- [Hashcat](https://hashcat.net/hashcat/) - Password recovery tool (Free)
- [Aircrack-ng](https://www.aircrack-ng.org/) - WiFi security auditing (Free)
- [Kali Linux](https://www.kali.org/) - Penetration testing distribution (Free)
- [Parrot Security](https://parrotsec.org/) - Security-focused Linux distribution (Free)
...
- [Solana CLI](https://docs.solana.com/cli) - Solana command-line interface
- [Anchor CLI](https://www.anchor-lang.com/docs/cli) - Anchor command-line interface
...
- [Docker Cheat Sheet](https://dockerlabs.collabnix.com/docker/cheatsheet/) - Docker commands
- [Kubernetes Cheat Sheet](https://kubernetes.io/docs/reference/kubectl/cheatsheet/) - kubectl commands
- [AWS CLI Cheat Sheet](https://docs.aws.amazon.com/cli/latest/userguide/cli-cheatsheet.html) - AWS commands
- [SQL Cheat Sheet](https://www.sqltutorial.org/sql-cheat-sheet/) - SQL commands
- [Vim Cheat Sheet](https://vim.rtorr.com/) - Vim editor commands
- [Emacs Cheat Sheet](https://www.gnu.org/software/emacs/refcards/pdf/refcard.pdf) - Emacs commands
- [Bash Cheat Sheet](https://devhints.io/bash) - Bash scripting
...
- [AWS Documentation](https://docs.aws.amazon.com/) - Amazon Web Services docs
- [Google Cloud Documentation](https://cloud.google.com/docs) - Google Cloud docs
- [Azure Documentation](https://docs.microsoft.com/en-us/azure/) - Microsoft Azure docs
